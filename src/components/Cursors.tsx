...
const Cursors = ({ peopleRef, meRef, sendJsonMessage }: {
    ...
    return <>
        ...
        {getSetting("hideAllCursors", false) ? "" : peopleRef.current.map(z => getUserRestrictions(z._id).includes("cursor") ? undefined : <span className="absolute transition-all text-xs"
